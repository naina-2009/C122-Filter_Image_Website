...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/hWpoR5qa_/model.json',modelLoaded);
...
function speak()
{
    ...
    var utter = new SpeechSynthesisUtterance(speak_data + speak_data_2);
    synth.speak(utter);
}
